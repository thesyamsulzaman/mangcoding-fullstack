...
<div class="container">
  <div class="min-w-[450px] mt-26">
    <form method="POST" action="{{ route('categories.update', $category) }}" enctype="multipart/form-data" class="space-y-5 p-8">
      @csrf
      @method('patch')
      ...
      <fieldset>
        ...
        <input name="name" class="form-control" value="{{ $category->name }}" placeholder="Enter name">
      ...
      <fieldset>
        <img width="180" src="{{ url('/uploads/'.$category->photo) }}" alt="">
